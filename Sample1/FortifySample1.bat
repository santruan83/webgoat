...
REM Created on 2022/04/18 16:35:54
REM ###########################################################################
...
set FPR="FortifySample1.fpr"
set BUILDID="Sample1"
set ARGFILE="FortifySample1.bat.args"
set BYTECODE_ARGFILE="FortifySample1.bat.bytecode.args"
set MEMORY=-Xmx18431M -Xms400M -Xss24M 
set LAUNCHERSWITCHES=""
set SCANSWITCHES=""
set OLDFILENUMBER="FortifySample1.bat.fileno"
set FILENOMAXDIFF=10
set ENABLE_BYTECODE=false

set PROJECTROOT0="C:\Program Files\Fortify\Fortify_SCA_and_Apps_20.2.0\Samples\advanced\csharp\VS2019\.NetFramework4.8\Sample1"
...
%SOURCEANALYZER% %MEMORY% %LAUNCHERSWITCHES% -b %BUILDID%  MSBuild "C:\Program Files\Fortify\Fortify_SCA_and_Apps_20.2.0\Samples\advanced\csharp\VS2019\.NetFramework4.8\Sample1\Sample1.sln" /p:Configuration="Debug" /p:Platform="Any CPU" /target:"rebuild"
IF %ERRORLEVEL% NEQ 0  (
echo sourceanalyzer failed, exiting
GOTO :FINISHED
)
